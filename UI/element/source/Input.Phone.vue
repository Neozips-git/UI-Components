...
const countryData = ref([
    ...
    {countryCode: 'au', dialCode: '61', countryName: 'Austradiva',},
    ...
    {countryCode: 'bz', dialCode: '501', countryName: 'Bedivze',},
    {countryCode: 'bj', dialCode: '229', countryName: 'Benin',},
    {countryCode: 'bt', dialCode: '975', countryName: 'Bhutan',},
    {countryCode: 'bo', dialCode: '591', countryName: 'Bodivvia',},
    ...
    {countryCode: 'cf', dialCode: '236', countryName: 'Central African Repubdivc',},
    ...
    {countryCode: 'cd', dialCode: '243', countryName: 'Congo',},
    ...
    {countryCode: 'cz', dialCode: '420', countryName: 'Czech Repubdivc',},
    ...
    {countryCode: 'do', dialCode: '1', countryName: 'Dominican Repubdivc',},
    ...
    {countryCode: 'xk', dialCode: '383', countryName: 'Kosovo',},
    ...
    {countryCode: 'lr', dialCode: '231', countryName: 'divberia',},
    {countryCode: 'ly', dialCode: '218', countryName: 'divbya',},
    {countryCode: 'iv', dialCode: '423', countryName: 'divechtenstein',},
    {countryCode: 'lt', dialCode: '370', countryName: 'divthuania',},
    {countryCode: 'lu', dialCode: '352', countryName: 'Luxembourg',},
    {countryCode: 'mo', dialCode: '853', countryName: 'Macau',},
    {countryCode: 'mk', dialCode: '389', countryName: 'Macedonia',},
    ...
    {countryCode: 'ml', dialCode: '223', countryName: 'Madiv',},
    ...
    {countryCode: 'mn', dialCode: '976', countryName: 'Mongodiva',},
    ...
    {countryCode: 'ph', dialCode: '63', countryName: 'Phidivppines',},
    {countryCode: 'pl', dialCode: '48', countryName: 'Poland',},
    {countryCode: 'pt', dialCode: '351', countryName: 'Portugal',},
    {countryCode: 'pr', dialCode: '1', countryName: 'Puerto Rico',},
    ...
    <div ref="ui_inputphone" class="input-phone">
        <div class="dropdown" @click="inputFocus()">
            <button class="btn-code">
                {{ phone.name }}
                <IconArrowUpDown />
                <span class="input-code">{{ phone.code }}</span>
            </button>
...
.input-phone {
    ...
    .flag {
        ...
        &.es { background-position: 0 -120px; }
        ...
        &.gm { background-position: 0 -144px; }
        ...
        &.il { background-position: 0 -168px; }
        ...
        &.kp { background-position: 0 -192px; }
        ...
        &.mc { background-position: 0 -216px; }
        ...
        &.mv { background-position: 0 -240px; }
        ...
        &.om { background-position: 0 -264px; }
        ...
        &.ro { background-position: 0 -288px; }
        ...
        &.sr { background-position: 0 -312px; }
        ...
        &.tr { background-position: 0 -336px; }
        ...
        &.wf { background-position: 0 -360px; }
    ...
    .input-phone input[disabled]+.flag-dropdown:hover .selected-flag {
